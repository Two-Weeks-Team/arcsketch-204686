...
> Live collaborative sketch board for architects – sketch, sync, export.

---

## Overview

Remote design teams spend hours emailing screenshots, PDFs, or hand‑drawn sketches, slowing feedback loops and causing version‑control chaos.
...
| `GET` | `/health` |
| `GET` | `/` |
| `POST` | `/projects/{project_id}/ai/snap` |
| `POST` | `/projects/{project_id}/ai/suggest` |
